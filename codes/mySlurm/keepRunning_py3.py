...
def keepRunning(argv):
    ...
    restartCommand = mpirun + ' ' + exe + ' ' + TO-DO (what arguments should be used here, during restart?)
    ...
    while(True):
        ...
        userName = ' TO-DO:  FILL IN YOUR USER NAME HERE '
        jobName = exe
